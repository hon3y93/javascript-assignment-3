...
var productbox= document.getElementById('clothingCards');
var accessorybox= document.getElementById('accessoriesCards');
...
var productList = [
  ...
  productList.forEach(function(val,index,list){
    ...
    var newName = document.createTextNode(val.name);
    ...
    var newBrand = document.createTextNode(val.brand);
    ...
    var newPrice = document.createTextNode(val.price);
...
if(val.isAccessory){
    accessoriesCards.appendChild(cardElement);
  
  
  }else{
    clothingCards.appendChild(cardElement);
